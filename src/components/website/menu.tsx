...
import { navigate, ActiveLink } from "raviger";
  ...
  return (
    <div className="left-0 bottom-0 top-0 px-3 py-5 text-gray-200 w-80 bg-slate-600 rounded-r-sm">
      ...
      <div className="overflow-y-hidden flex flex-col justify-self-center text-center py-3 my-1">
        ...
        <ActiveLink href="/web/credentials" activeClass="w-100 cards px-3 py-3 my-1 rounded-md cursor-pointer hover:bg-white hover:text-gray-600 border-2 border-gray-200" exactActiveClass="w-100 cards px-3 py-3 my-1 max-w-screen rounded-md cursor-pointer bg-white text-gray-600" className="w-100 cards px-3 py-3 my-1 rounded-md cursor-pointer hover:bg-white hover:text-gray-600">
          My Credentials
        </ActiveLink>
        <ActiveLink href="/web/threats" activeClass="w-100 cards px-3 py-3 my-1 rounded-md cursor-pointer hover:bg-white hover:text-gray-600 border-2 border-gray-200" exactActiveClass="w-100 cards px-3 py-3 my-1 max-w-screen rounded-md cursor-pointer bg-white text-gray-600" className="w-100 cards px-3 py-3 my-1 rounded-md cursor-pointer hover:bg-white hover:text-gray-600">
          Threats
        </ActiveLink>
        <ActiveLink href="/web/insights" activeClass="w-100 cards px-3 py-3 my-1 rounded-md cursor-pointer hover:bg-white hover:text-gray-600 border-2 border-gray-200" exactActiveClass="w-100 cards px-3 py-3 my-1 max-w-screen rounded-md cursor-pointer bg-white text-gray-600" className="w-100 cards px-3 py-3 my-1 rounded-md cursor-pointer hover:bg-white hover:text-gray-600">
          Insights
        </ActiveLink>
        <ActiveLink href="/web/controllers" activeClass="w-100 cards px-3 py-3 my-1 rounded-md cursor-pointer hover:bg-white hover:text-gray-600 border-2 border-gray-200" exactActiveClass="w-100 cards px-3 py-3 my-1 max-w-screen rounded-md cursor-pointer bg-white text-gray-600" className="w-100 cards px-3 py-3 my-1 rounded-md cursor-pointer hover:bg-white hover:text-gray-600">
          Controllers
        </ActiveLink>
        <ActiveLink href="/web/network" activeClass="w-100 cards px-3 py-3 my-1 rounded-md cursor-pointer hover:bg-white hover:text-gray-600 border-2 border-gray-200" exactActiveClass="w-100 cards px-3 py-3 my-1 max-w-screen rounded-md cursor-pointer bg-white text-gray-600" className="w-100 cards px-3 py-3 my-1 rounded-md cursor-pointer hover:bg-white hover:text-gray-600">
          My Network
        </ActiveLink>
        <ActiveLink
          href="/web/scans"
